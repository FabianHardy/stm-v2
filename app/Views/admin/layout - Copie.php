                ...
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        <a href="/stm/admin/dashboard" 
                           class="<?php echo (strpos($_SERVER['REQUEST_URI'], '/dashboard') !== false) ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'; ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            📊 Dashboard
                        </a>
                        <a href="/stm/admin/campaigns" 
                           class="<?php echo (strpos($_SERVER['REQUEST_URI'], '/campaigns') !== false) ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'; ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            🎯 Campagnes
                        </a>
                    </div>
                </div>

...
/**
 * Vérifie qu'une combinaison de valeurs est unique en base de données
 * 
 * Utile pour les contraintes UNIQUE composites (ex: product_code + campaign_id)
 * 
 * @param array $fields Tableau associatif [champ => colonne_db]
 *                     Ex: ['product_code' => 'product_code', 'campaign_id' => 'campaign_id']
 * @param string $table Nom de la table
 * @param int|null $excludeId ID à exclure (pour updates)
 * @param string|null $message Message d'erreur personnalisé
 * @return self
 ...
 *     'products',
 *     null,
 *     'Ce code produit existe déjà dans cette campagne.'
 * );
 * 
 * @example

        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-medium text-gray-900">Campagnes accessibles</h3>
                ...
                <?php if (empty($campaigns)): ?>
                    <div class="text-center py-8">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Ce client n'a accès à aucune campagne pour le moment</p>
                    </div>
                <?php else: ?>
                    <div class="space-y-3">

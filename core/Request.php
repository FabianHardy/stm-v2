 ...
 * Version : 1.1
 * 
 * @modified 12/11/2025 16:45 - SUPPRESSION method spoofing pour respecter pattern STM
 */
...
class Request
{
     ...
     * 
     * ⚠️ IMPORTANT : STM v2 utilise UNIQUEMENT POST pour create/update/delete
     * Pas de method spoofing (PUT/DELETE/PATCH) pour simplicité hébergement mutualisé
     * 
     * @return string Méthode HTTP
     * @modified 12/11/2025 16:45 - Suppression method spoofing
     */
    private function detectMethod(): string
    {
        $method = strtoupper($_SERVER['REQUEST_METHOD'] ?? 'GET');

        // ❌ SUPPRIMÉ : Support de _method (method spoofing)
        // STM v2 utilise POST uniquement pour toutes les actions
        // Raison : Compatibilité hébergement mutualisé O2switch
        // 

...
<div class="mt-6 pt-6 border-t border-gray-700">
    ...
    <a href="/stm/admin/dev-tools/sync-db" 
       class="flex items-center gap-3 px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg transition <?= strpos($_SERVER['REQUEST_URI'], '/dev-tools/sync-db') !== false ? 'bg-gray-700 text-white' : '' ?>">
        <svg class="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4"></path>
        </svg>
        <span>Sync Base de données</span>
    </a>
    
    <!-- Synchronisation Fichiers -->
    <a href="/stm/admin/dev-tools/sync-files" 
       class="flex items-center gap-3 px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg transition <?= strpos($_SERVER['REQUEST_URI'], '/dev-tools/sync-files') !== false ? 'bg-gray-700 text-white' : '' ?>">
        <svg class="w-5 h-5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path>
        </svg>
        <span>Sync Fichiers</span>
    </a>
</div>
<?php endif; ?>

 ...
 * 
 * Formulaire de modification des informations d'un client
 * 
...
<div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Client #<?= htmlspecialchars($customer['customer_number']) ?> - <?= htmlspecialchars($customer['name']) ?>
                </p>
            </div>
        </div>
    </div>
    ...
    <!-- Formulaire -->
    <form method="POST" action="/stm/admin/customers/<?= $customer['id'] ?>" class="space-y-6" x-data="customerForm()">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="<?= htmlspecialchars($data['customer_number'] ?? '') ?>"
                           required
                ...
                <div>
                    ...
                    <select id="country" 
                        ...
                        <option value="BE" <?= ($data['country'] ?? '') === 'BE' ? 'selected' : '' ?>>🇧🇪 Belgique</option>
                            ...
                            <optgroup label="Belgique">
                                <?php foreach ($representatives['BE'] ?? [] as $rep): ?>
                                    <option value="<?= htmlspecialchars($rep) ?>" 
                                            <?= ($data['representative'] ?? '') === $rep ? 'selected' : '' ?>>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="segment" 
                           name="segment" 
                           value="<?= htmlspecialchars($data['segment'] ?? '') ?>"
...
$title = 'Modifier : ' . htmlspecialchars($customer['name']);

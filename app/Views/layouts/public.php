...
<?php
// Construire les attributs du body
// Si bodyAttrs est vide et qu'on a des footerPages, ajouter x-data pour la modal
$finalBodyAttrs = $bodyAttrs;
if (empty($bodyAttrs) && !empty($footerPages)) {
    $finalBodyAttrs = 'x-data="{ footerModalOpen: false, footerModalUrl: \'\', footerModalTitle: \'\' }"';
}
?>
<body class="bg-gray-50 <?= htmlspecialchars($bodyClass) ?>" <?= $finalBodyAttrs ?>>
<?php
// Bandeau DEV

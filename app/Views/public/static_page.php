    ...
    <header class="bg-white shadow-sm">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <!-- Logo / Retour -->
                <a href="/stm/c/<?= htmlspecialchars($campaign['uuid']) ?>" class="flex items-center gap-3 text-gray-700 hover:text-purple-600">
                    <i class="fas fa-arrow-left"></i>
                    <span class="font-medium">Retour à la campagne</span>
                </a>
                ...
                <div class="flex items-center gap-2">
                    <a href="?lang=fr" 
                       class="px-3 py-1.5 rounded text-sm font-medium <?= $currentLanguage === 'fr' ? 'bg-purple-100 text-purple-700' : 'text-gray-500 hover:bg-gray-100' ?>">
                        🇫🇷 FR
                    </a>
                    <a href="?lang=nl" 
                       class="px-3 py-1.5 rounded text-sm font-medium <?= $currentLanguage === 'nl' ? 'bg-purple-100 text-purple-700' : 'text-gray-500 hover:bg-gray-100' ?>">
                        🇳🇱 NL
                    </a>
                </div>
                <?php endif; ?>
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <nav class="flex flex-wrap gap-4 text-sm">
                    ...
                    <a href="/stm/c/<?= htmlspecialchars($campaign['uuid']) ?>/page/<?= htmlspecialchars($footerPage['slug']) ?>" 
                       class="text-gray-500 hover:text-purple-600 <?= $footerPage['slug'] === $slug ? 'text-purple-600 font-medium' : '' ?>">

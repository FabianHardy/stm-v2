 ...
 * @modified 2025/12/30 - CGV dynamiques + Footer pages statiques
 */
...
// Récupérer les CGV dynamiques depuis la DB
$legalTextModel = new \App\Models\LegalText();
$legalTexts = $legalTextModel->getForCheckoutRendered($lang, $campaign['uuid']);
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 sticky top-24">
                        ...
                        <form method="POST" action="/stm/c/<?= $campaign['uuid'] ?>/order/submit" id="checkoutForm">
                            ...
                            <!-- Conditions Générales de Vente (checkboxes dynamiques) -->
                            ...
                            <div class="mb-6 space-y-3">
                                ...
                                <?php foreach ($legalTexts as $legalText): ?>

                                <label class="flex items-start cursor-pointer">

                                    <input type="checkbox" 

                                           name="<?= htmlspecialchars($legalText['code']) ?>" 

                                           <?= $legalText['is_required'] ? 'required' : '' ?>

                                           class="mt-1 h-4 w-4 text-orange-600 border-gray-300 rounded focus:ring-orange-500">

                                    <span class="ml-3 text-sm text-gray-700">

                                        <?= $legalText['rendered_text'] ?>
        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <p class="text-sm text-gray-400 text-center md:text-right">
                    © <?= date('Y') ?> Trendy Foods. <?= $lang === 'fr' ? 'Tous droits réservés.' : 'Alle rechten voorbehouden.' ?>
                </p>
            </div>
        </div>
    </footer>
